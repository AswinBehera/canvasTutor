...
export const ControlsPanel = React.memo(function ControlsPanel({
  ...
  return (
    <div className="flex items-center justify-between w-full m-4">
      <Link to="/" className="text-2xl font-bold text-primary mr-4">CanvasTutor</Link>
        ...
        <Card className="p-2 h-24">
          ...
          <CardContent className="p-0 pt-2">
            <Slider
              ...
              className="w-32" // Constrain slider width
            />
          </CardContent>
        </Card>
        <Card className="p-2 h-24">
          ...
          <CardContent className="p-0 pt-2">
            <Input
              ...
              className="w-24 text-center" // Constrain input width
            />
          </CardContent>
        </Card>
        <Card className="p-2 h-24">
          ...
          <CardContent className="p-0 pt-2">
            ...
            >
              <ToggleGroupItem value="off" className="px-2 py-1">Off</ToggleGroupItem>
              <ToggleGroupItem value="small" className="px-2 py-1">Small</ToggleGroupItem>
              <ToggleGroupItem value="large" className="px-2 py-1">Large</ToggleGroupItem>
            </ToggleGroup>
          </CardContent>
        </Card>
        <Card className="p-2 h-24">
          ...
          <CardContent className="p-0 pt-2">
            ...
            >
              <ToggleGroupItem value="managed" className="px-2 py-1">Managed</ToggleGroupItem>
              <ToggleGroupItem value="diy" className="px-2 py-1">DIY</ToggleGroupItem>
            </ToggleGroup>
          </CardContent>
        </Card>
